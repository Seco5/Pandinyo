...
const styles = StyleSheet.create({
  ...
  charCardActive: { borderColor: colors.accent },
  charImg: { width: '100%', height: 150 },
  charInfo: { padding: 12 },
  charName: { fontFamily: fonts.bold, fontSize: 17, color: colors.primary },
  charTag: { fontFamily: fonts.regular, fontSize: 12, color: colors.muted, marginTop: 2 },
  charCheck: { position: 'absolute', top: 8, right: 8, backgroundColor: '#000000', borderRadius: 12 },
});
